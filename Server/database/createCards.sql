...
INSERT INTO card (type, name, tag, bodyText, subtext,moneyCost,workerCost,minDamage,maxDamage,multiplier,weight)
VALUES ('positive', 'TV ADS','tv_ads', '4 to 6','Comcast for president',5,3,4,6,1,8);
...
INSERT INTO card (type, name, tag, bodyText, subtext,moneyCost,workerCost,minDamage,maxDamage,multiplier,weight)
VALUES ('negative', 'NEGATIVE TV ADS','tv_ads_neg', '10','Video killed the radio star',5,3,10,10,1,7);
